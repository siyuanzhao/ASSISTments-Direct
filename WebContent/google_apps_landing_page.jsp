	...
	$(function(){
		...
		$(".navbar_item").click(function(){
			...
			if(id == "landing_page" || id == "logo"){
				...
				window.location.assign("/direct/SkillBuilderGoogleClassroom?folder_id=210644&tool_type=skill_builder");
			}else if(id == "chemistry_page"){
				toolSelected = "chemistry_link";
				window.location.assign("/direct/SkillBuilderGoogleClassroom?folder_id=226695&tool_type=skill_builder");
			}
...
<body>
	...
	<div class="container_customize">
		<div class="navbar-header">
			...
			<a class="navbar-brand navbar_item" id="logo"><img src="images/ASSISTments_APP_logo.png" style="width:30px; display:inline;margin-right:5px;"/>ASSISTments App</a>
		</div>
	...
	<div class="jumbotron" style="background-color:white; height:600px;">
		...
		<div id="alert_panel" style="margin-top:30px; text-align: center" class="alert alert-info alert-dismissible fade in" role="alert">
		<!-- <button class='close' aria-label='Close' data-dismiss='alert' type='button'><span aria-hidden='true'>&times;</span></button> -->
			Sorry... It seems that you already logged out from Google.<br>
			Please login Google first and then access ASSISTments App.
		</div>
		</div>
	</div>
